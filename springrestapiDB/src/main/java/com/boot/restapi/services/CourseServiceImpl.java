...
import com.boot.restapi.dao.CourseDao;
...
//List<Course> list;
	...
	/*  list=new ArrayList<>(); list.add(new
	  Course(101,"Java Core Course","This course contains basics of java"));
	  list.add(new
	  Course(102,"Spring Boot course","creating rest api using Spring Boot"));
	  */
